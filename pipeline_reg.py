...
class IDEX:
	...
	def set(self, i_in, d_in, sEx_in, p_in, rd1_in, rd2_in, b_in, j_in, wb_in, mem_in, ex_in):
		self.instruction_in = i_in
...
class EXMEM:
	...
	def set(self, i_in, destReg_in, rd2_in, aluR_in, z_in, wbc_in, memc_in):
		self.instruction_in = i_in
